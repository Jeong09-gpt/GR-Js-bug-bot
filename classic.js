...
› Create By Re-Jeong Guanxii
› Button by Ntando Ofc
...
` ★彡 GR-Js-bug-bot.git彡★ `
]
let { key } = await zetsubo.sendMessage(from, {text: '@⫹⸙⧉GR-Js-bug-bot.git⧉⸙⫺.....'})//Pengalih isu
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "🖤⟩ ༘྅GR-Js-bug Bot Territory ꧏ🤍҈ ༑",
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
    \`GR-Js-bug-bot.git\`
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
   ✰ 𝐒𝐜 𝐏𝐮𝐛𝐥𝐢𝐜 ❴ 𝐵𝑌 Re-Jeong Guanxii ❵
   ✰ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫: Re-Jeong Guanxii
...
image: cewegw, 
  ...
  title: 'ᚙᚘ ⫹⸙⧉GR-Js-bug-bot.git ⧉⸙⫺   - 𝐊ᚗ𝐈𝐍ᚗ𝐆 ᚘᚙ',
...
case 'Islammenu': {
                            ...
                            ewe = ` *GR-Js-bug-bot.git 𝗕𝗢𝗧*
┃  ➥𝐒𝐜 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 ❴ 𝐵Y Re-Jeong Guanxii ❵
┃  ➥ 𝐔𝐬𝐞𝐫 : ${pushname}}
┃  ➥𝐂𝐨𝐧𝐭𝐚𝐜𝐭 : @${m.sender.split('@')[0]}
┃
┣╼╼❴ ⧠ ᏴϴͲ ᏆΝҒϴ ⧠ ❵╼╼╼
...
image: cewegw, 
  ...
  contextInfo:{externalAdReply:{
  title: '𒑰⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ᚗ𝐒⸙𝐀࿈𝐌⸙⧉',
  body: '༐༑⿻⫹⸙⧉GR-Js-bug-bot.git⧉⸙⫺',showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/a3b5de3c2cd44f6b3aa80.jpg`,
  sourceUrl:`https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg==`,
...
case 'cucimata': {
                            ...
                            ewe = `┏━━━▓ *GR-Js-bug-bot.git 𝗕𝗢𝗧* ▓━━━━━━━
┃  ➥𝐒𝐜 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 ❴ 𝐵𝑌 Re-Jeong Guanxii ❵
┃  ➥ 𝐔𝐬𝐞𝐫 : ${pushname}}
┃  ➥𝐂𝐨𝐧𝐭𝐚𝐜𝐭 : @${m.sender.split('@')[0]}
┃
┣╼╼❴ ⧠ ᏴϴͲ ᏆΝҒϴ ⧠ ❵╼╼╼
...
┏━━━━━━━━━━━━━━━━
 ...
 ➨𝐓𝐲𝐩𝐞 .𝐨𝐰𝐧𝐞𝐫
 ➨ 𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠 GR-Js-bug-bot.git 𝐁𝐨𝐭
┗━━━━━━━━━━━━━━━━━━
...
await sleep(1000)
await ryobug(sendto, jumlah,  `GR-Js-bug-bot.git 🫂`)
await sleep(1000)
...
let listMessage = {
    text: `💣Re-Jeong Guanxii 💀`,
    footer: `🍻°⃟૰𝐤𝐢𝐥𝐥𝐞𝐫 -!ˢᵃᵐˢ🍺ꢵ`,
    buttonText: `GR-Js-bug - bot.git`,
    sections
};
...
await reply('💊𝗧𝗮𝗿𝗴𝗲𝘁 𝗘𝗹𝗶𝗺𝗶𝗻𝗮𝘁𝗲𝗱 𝗯𝘆 Re-Jeong Guanxii 📡')
}
break
//=================================================
case 'null-chace': {
...
text: '📡A true friend is the one who lay his life down for a friend.Jesus said not me🩸'
}, {
quoted: m
})
}
...
//=================================================
case 'runtime':
                let pinga = `GR-Js-bug-bot.git 𝐁𝐨𝐭 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐟𝐨𝐫 ${runtime(process.uptime())}`
                zetsubo.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
...
`╭╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╮\n\n ➨ 𝑯𝒊 *${pushname}* \n\n ➨ 𝑰 𝒂𝒎 GR-Js-bug_𝑨𝑰 𝑩𝑶𝑻 ☣.\n\n ➨ 𝒀𝒐𝒖 𝑪𝒂𝒏 𝑮𝒆𝒕 𝑴𝒚 𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆 𝑽𝒊𝒂.\n\n ➨ 𝑻𝒉𝒆 𝑳𝒊𝒏𝒌 𝑩𝒆𝒍𝒐𝒘 ⇣⇣.\n\n ➨𝑭𝒐𝒓𝒌 𝑨𝒏𝒅 𝑮𝒊𝒗𝒆 𝑨 𝑺𝒕𝒂𝒓 ➻ ❴ https://github.com/Jeong09-gpt/GR-Js-bug-bot.git ❵\n\n ➨ 𝑹𝒆𝒎𝒆𝒎𝒃𝒆𝒓 𝒕𝒐 𝒕𝒂𝒌𝒆 𝒂 𝒍𝒐𝒐𝒌 𝒐𝒏 𝒓𝒆𝒂𝒅𝒎𝒆 𝒃𝒆𝒇𝒐𝒓𝒆 𝒅𝒆𝒑𝒍𝒐𝒚𝒎𝒆𝒏𝒕.\n\n ➨ 𝑴𝒂𝒅𝒆 𝑩𝒚 ➻ Re-Jeong Guanxii ✇\n\n╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯⸼` });
                ...
                for (let i of anu) {
                    ...
                    zetsubo.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                                title: '𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓𝐄𝐃 𝐁𝐘 GR-Js 𝐁𝐎𝐓',
...
const audiovn = "./GR-Js-bug.mp3";
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝐇𝐢 𝐇𝐮𝐦𝐚𝐧,Re-Jeong Guanxii 𝐁𝐨𝐭 𝐈𝐬 𝐀𝐥𝐢𝐯𝐞 𝐚𝐧𝐝 𝐊𝐢𝐜𝐤𝐢𝐧𝐠",
...
case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`use -take GR-Js Bot|By: Re-Jeong Guanxii`)
        const swn = args.join(" ")
...
await inireact()
  ...
  reply(`*Restarting Re-Jeong Guanxii* .`)  
  await sleep(3000)  
  process.exit()  
  break;
//=================================================//
...
await inireact()
 ...
 bar = `𝐏𝐫𝐨𝐟𝐢𝐥𝐞 𝐩𝐢𝐜𝐭𝐮𝐫𝐞 𝐨𝐟 ${qd} 𝐠𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 Re-Jeong Guanxii-𝐀𝐢`; 
...
case 'play':
    case 'music': {
        ...
        try {
			...
			caption: "💢 GR-Js-bug-bot.git_𝐁𝐎𝐓 𝐁𝐘 Re-Jeong Guanxii 🩸 ",    
                    }, {
                        quoted: m 
                    }
                );
